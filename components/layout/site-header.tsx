...
export function SiteHeader() {
  ...
  const isProtectedPath = pathname === '/dashboard' || pathname.startsWith('/dashboard/') || pathname === '/applications' || pathname.startsWith('/applications/') || pathname === '/resumes' || pathname.startsWith('/resumes/');
  const showNavigation = Boolean(user) || isProtectedPath;
